...
# This .env file has the api keys
...
ISTHEREANYDEAL_API_KEY = os.getenv("ISTHEREANYDEAL_API_KEY")
# Using Plat Prices to get playsation game price
PLAT_PRICES_API_KEY = os.getenv("PLAT_PRICES_API_KEY")
# Using to get steam account ID if linking
